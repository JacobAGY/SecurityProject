...
public class ShortTimePlan_test {
    ...
    public ShortTimePlan_test(List<Equipment> equipmentList, List<Resource> resourceList) {
...
//                entry.setValue(entry.getValue()+curTime);
    ...
    public static void main(String[] args) {
        ...
        ShortTimePlan_test scheduler = new ShortTimePlan_test(equipmentList,resourceList);
